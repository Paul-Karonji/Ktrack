...
import { Users, Search, Plus, Trash2, Edit2, AlertTriangle, Phone, Mail, BookOpen, Menu } from 'lucide-react';
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                        <div>
                            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 flex items-center gap-3">
                                ...
                                <Users className="text-indigo-600 hidden lg:block" size={48} />
                                <span className="flex items-center gap-2">
                                    <Users className="text-indigo-600 lg:hidden" size={32} />
                                    Guest Clients
                                </span>
                            </h1>
                            <p className="text-gray-500 mt-1 ml-10 lg:ml-0">Manage external clients and their tasks</p>
                        </div>
                        <button
                            onClick={() => setShowForm(!showForm)}
                            className="flex items-center gap-2 bg-indigo-600 text-white px-5 py-2.5 rounded-xl hover:bg-indigo-700 transition-all font-semibold shadow-lg shadow-indigo-200 w-full md:w-auto justify-center"
                        >
                            <Plus size={20} />
