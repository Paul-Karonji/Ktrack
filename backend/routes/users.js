...
router.put('/:id/reject', requireSuperadmin, userController.rejectUser);
router.put('/:id/suspend', requireSuperadmin, userController.suspendUser);
router.put('/:id/unsuspend', requireSuperadmin, userController.unsuspendUser);
